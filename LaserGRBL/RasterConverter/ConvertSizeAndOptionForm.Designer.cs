...
namespace LaserGRBL.RasterConverter
{
	partial class ConvertSizeAndOptionForm
	{
      ...
      this.powerPercentageIntegerInput = new LaserGRBL.UserControls.NumericInput.IntegerInputRanged();
      this.powerPercentageLabel = new System.Windows.Forms.Label();
      ...
      this.tableLayoutPanel7.Controls.Add(this.powerPercentageLabel, 0, 2);
      this.tableLayoutPanel7.Controls.Add(this.powerPercentageIntegerInput, 0, 2);
      ...
      // 
      // powerPercentageIntegerInput
      // 
      resources.ApplyResources(this.powerPercentageIntegerInput, "powerPercentageIntegerInput");
      this.powerPercentageIntegerInput.ForcedText = null;
      this.powerPercentageIntegerInput.ForceMinMax = false;
      this.powerPercentageIntegerInput.MaxValue = 999;
      this.powerPercentageIntegerInput.MinValue = 0;
      this.powerPercentageIntegerInput.Name = "powerPercentageIntegerInput";
      this.powerPercentageIntegerInput.NormalBorderColor = System.Drawing.SystemColors.ActiveBorder;
      this.powerPercentageIntegerInput.CurrentValueChanged += new LaserGRBL.UserControls.NumericInput.IntegerInputBase.CurrentValueChangedEventHandler(this.powerPercentageIntegerInput_CurrentValueChanged);
      // 
      // powerPercentageLabel
      // 
      resources.ApplyResources(this.powerPercentageLabel, "powerPercentageLabel");
      this.powerPercentageLabel.Name = "powerPercentageLabel";
      // 
    ...
    private System.Windows.Forms.Label powerPercentageLabel;
    private UserControls.NumericInput.IntegerInputRanged powerPercentageIntegerInput;
  }
}
